...
% Candidate edges from o3
\draw[candidedge] (o3) -- (o6);
\draw[candidedge] (o3) -- (o7);
...
\node[draw=none, rectangle, anchor=north west, align=left, font=\scriptsize, text=black]
    at (-0.5,-0.8) {$\mathcal{O}_{\text{sub}} = \{o_6, o_7\}$, \quad $Q = \{(2, o_6, [o_0,o_1,o_6])\}$};
\end{tikzpicture}
